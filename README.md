...
- Storage: GitHub orphan branch (separate from code for clean architecture)
...
**Note:** Data files are stored in a separate `data-storage` branch, not in the main codebase.
...
These files are publicly accessible from the data-storage branch:
```
